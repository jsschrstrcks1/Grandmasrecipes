...
description: "Audits WCAG 2.1 AA compliance for Grandma Baker's Kitchen — validates image alt text, color contrast, heading hierarchy, form labels, keyboard navigation, and screen reader compatibility on recipe pages."
version: 1.0.0
---

# Accessibility Audit — Grandma Baker's Kitchen

> These recipes are for everyone — including those who use screen readers, keyboard navigation, or assistive technology.

## Purpose

Validates WCAG 2.1 AA compliance across the recipe website pages: calculator.html, index.html, recipe.html. Ensures recipe content, search features, and interactive elements are accessible to all users.
