...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /grandmasrecipes --limit 10
python3 /home/user/.memory/memory_ops.py tree /grandmasrecipes
```
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /grandmasrecipes
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /grandmasrecipes --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /grandmasrecipes --older-than 90
```
