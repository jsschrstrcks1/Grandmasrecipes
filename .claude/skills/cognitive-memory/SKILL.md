...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /recipes/grandma --limit 10
python3 /home/user/.memory/memory_ops.py tree /recipes/grandma
```
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /recipes/grandma
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/grandma --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/grandma --older-than 90
```
