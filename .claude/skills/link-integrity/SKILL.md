---
name: link-integrity
description: "Validates internal links, image references, and page connectivity for Grandma Baker's Kitchen. Catches broken recipe links, missing images, and dead anchors."
version: 1.0.0
---

# Link Integrity — Grandma Baker's Kitchen
...
```
## Link Integrity — Grandma Baker's Kitchen — [date]
**Files checked:** [count]
**Broken:** [count]
