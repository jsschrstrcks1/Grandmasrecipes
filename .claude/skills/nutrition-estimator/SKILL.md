...
description: "Wraps the nutrition estimation scripts with skill-level guidance. Knows when to run estimates, how to interpret results, and how to handle unclear measurements for Grandma Baker's recipes."
version: 1.0.0
---

# Nutrition Estimator — Grandma Baker
...
python3 scripts/estimate_nutrition.py --collection grandma
```
